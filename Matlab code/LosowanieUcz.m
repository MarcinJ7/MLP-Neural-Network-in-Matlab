function[Xwe,Ywe]=LosowanieUcz(M,numerPrzykladu) %M - jest to iloœæ argumentów, zwracamy wartoœci X i Y 
...
%funkcje uczace: 
y1=3*x.*x+2*x-0.2; %numer 1przykladu
y2=x.*x+2*x+0.3; %numer 2 przykladu itd 
y3=x.*x-x+0.1;
